...
import com.grzeluu.wateringreminder.databinding.ActivityEditPlantBinding;
...
public class EditPlantActivity extends AppCompatActivity {
    ...
    private static final int PIC_CROP = 8888;
    ...
    private View.OnClickListener takePhoto() {
        return v -> {
            if (ContextCompat.checkSelfPermission(EditPlantActivity.this, Manifest.permission.CAMERA)
                    != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(EditPlantActivity.this, new String[]{
